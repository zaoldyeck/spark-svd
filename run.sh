...
ssh ${domain}
nohup spark-submit --class SVDStarter ./spark-svd_2.11-1.0.jar 2>log &
spark-submit --class SVDStarter ./spark-svd_2.11-1.0.jar
nohup spark-submit --queue longrun --class SVDStarter ./spark-svd_2.11-1.0.jar 2>log &